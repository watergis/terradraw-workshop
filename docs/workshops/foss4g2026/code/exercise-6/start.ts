...
map.once('load', () => {
	...
	// 1. Add a default point feature at the Atomic Bomb Dome in
	//    Hiroshima ([132.45361, 34.39556]) using draw.addFeatures().
	//    Don't forget the `mode: 'point'` property!
});
...
// 2. Add a "Delete" button that removes the selected feature with
//    draw.removeFeatures().
