...
Everything you learned in this workshop was written against MapLibre GL JS — but Terra Draw's biggest strength is that the very same code works with all major web mapping libraries. Only the **adapter** changes.
...
Let's start with the migration exercise: [Switching to Leaflet](./leaflet.md).
