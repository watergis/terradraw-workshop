...
We use [SvelteKit](https://svelte.dev/docs/kit) for the local development environment as it provides an excellent developer experience with fast builds and hot reload.
