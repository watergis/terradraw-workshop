...
Terra Draw and the `maplibre-gl-terradraw` plugin have been presented at several FOSS4G conferences. This section collects those talks in one place — each event page links to the talk on Pretalx and embeds the slide deck and, where available, the recording.
...
If you are looking for the hands-on tutorial material instead, head to the [workshops](../workshops/index.md).
